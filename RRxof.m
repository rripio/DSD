...
% Un pequeño anuncio en pantalla
GSFs
FSOutPrefix
disp ("\n");
% MS Message Settings
...
% Hacemos igual la longitud de los filtros de corrección 
% de altavoz y la de los crossovers lineales (mitad de la final).
m=2^GSLExp; m2=m/2; % Final filter length
m_ls=m/2; m2_ls=m2/2; % Longitud de la corrección de altavoz
...
% Se mantiene sin tocar en dB, para ploteo
TFRMag=dB2mag(TFRdB);
IFRMag=1./TFRMag; % Inversión de la respuesta
% Normaliza la respuesta (sólo atenúa)
...
% Filtro de ecualización normalizado (solo atenúa)
